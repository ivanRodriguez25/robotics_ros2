...
bool pubsub_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pubsub_interfaces.msg._hardware_status.HardwareStatus", full_classname_dest, 53) == 0);
  }
  pubsub_interfaces__msg__HardwareStatus * ros_message = _ros_message;
  {  // version
...
PyObject * pubsub_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pubsub_interfaces.msg._hardware_status");
