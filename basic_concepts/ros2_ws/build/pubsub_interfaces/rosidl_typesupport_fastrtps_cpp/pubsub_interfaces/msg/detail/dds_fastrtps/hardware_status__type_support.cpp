...
#include "pubsub_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pubsub_interfaces::msg::HardwareStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pubsub_interfaces::msg::HardwareStatus & ros_message)
{
  // Member: version
  cdr >> ros_message.version;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pubsub_interfaces::msg::HardwareStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pubsub_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pubsub_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pubsub_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<pubsub_interfaces::msg::HardwareStatus>()
{
  return &pubsub_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pubsub_interfaces, msg, HardwareStatus)() {
  return &pubsub_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
