...
bool pubsub_interfaces__msg__turtle_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pubsub_interfaces.msg._turtle_pose.TurtlePose", full_classname_dest, 45) == 0);
  }
  pubsub_interfaces__msg__TurtlePose * ros_message = _ros_message;
  {  // x
...
PyObject * pubsub_interfaces__msg__turtle_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pubsub_interfaces.msg._turtle_pose");
